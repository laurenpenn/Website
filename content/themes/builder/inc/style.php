...
<?php if($data['alt_stylesheet'] == 'blue.css') { ?>
...
<?php if($data['alt_stylesheet'] == 'cayan.css') { ?>
...
<?php if($data['alt_stylesheet'] == 'green.css') { ?>
...
<?php if($data['alt_stylesheet'] == 'grunge.css') { ?>
...
<?php if($data['alt_stylesheet'] == 'light_blue.css') { ?>
...
<?php if($data['alt_stylesheet'] == 'light_green.css') { ?>
...
<?php if($data['alt_stylesheet'] == 'lime.css') { ?>
...
<?php if($data['alt_stylesheet'] == 'navy.css') { ?>
...
<?php if($data['alt_stylesheet'] == 'orange.css') { ?>
...
<?php if($data['alt_stylesheet'] == 'pink.css') { ?>
...
<?php if($data['alt_stylesheet'] == 'purple.css') { ?>
...
<?php if($data['alt_stylesheet'] == 'red.css') { ?>
