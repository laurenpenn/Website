...
<div class="tp-option-body">
  <table class="form-table">
    ...
    <tr valign="top">
      ...
      <td><input type="text" name="the_piecemaker[width]" value="<?php echo ($tpopts['width'])?$tpopts['width']:'980'; ?>"/>
    ...
    <tr valign="top">
      ...
      <td><input type="text" name="the_piecemaker[height]" value="<?php echo ($tpopts['height'])?$tpopts['height']:'360'; ?>"/>
