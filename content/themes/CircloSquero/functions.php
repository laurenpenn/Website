...
function dbc_cl_load_scripts() {
	...
	// Deregister included jQuery and register Google API version
	...
	wp_enqueue_script( 'supersubs',			trailingslashit( CHILD_THEME_URI ) .'scripts/featuredworks.js' );
	wp_enqueue_script( 'hoverIntent',			trailingslashit( CHILD_THEME_URI ) .'scripts/hoverIntent.js' );
