 ...
 * 
 * Displays a slider meant for the home page template. * Only displays if the settings are turned on. * * @package DBC Child * @subpackage Template */
...
<div id="slider-container"<?php	if (hybrid_get_setting('slider_16x9') == 'true') { echo ' class="widescreen"';	} ?>>
	<div class="slider">
		<?php if ( hybrid_get_setting( 'feature_category' ) )
