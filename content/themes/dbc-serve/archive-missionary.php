 ...
 // Loads the header.php template. ?>
	...
	<div id="content">
		...
		<div class="hfeed">
			...
			<a href="#" class="button right" data-reveal-id="modal-email-missionary">Email a Missionary</a> <a href="<?php echo home_url(); ?>/prayer/" class="button right">Pray for our missionaries</a>
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
						...
						<p><?php if ( current_theme_supports( 'get-the-image' ) ) get_the_image( array( 'default_image' => get_stylesheet_directory_uri(). '/images/noavatar.png', 'image_class' => 'avatar', 'meta_key' => 'Thumbnail', 'size' => 'medium' ) ); ?></p>
