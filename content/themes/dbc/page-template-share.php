	...
	<div id="content" role="main">
		...
		<section>
			...
			<div class="caption right">
				...
				<p><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/tom-rectangle.jpg" width="200" /></p>
		...
		<section>
			...
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/stopwatch.png" class="left" width="75" /></p>
