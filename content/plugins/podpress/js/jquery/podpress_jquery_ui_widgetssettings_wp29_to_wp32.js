podPress_jQuery(document).ready(function() {
	...
	// bind the Accordion effect after saving the widgets settings (2.9 <= WP <= 3.2.x)
	...
	// bind the Accordion effect after adding the widget to a sidebar in a 2.9 <= WP <= 3.2.x sidebar
