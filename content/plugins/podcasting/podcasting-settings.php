...
class PodcastingSettings
{
    ...
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
      ...
      <input type="hidden" name="hosted_button_id" value="KSBPYQJVW26C8">
      ...
      <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
		...
		<?php $this->nonceField(); ?>
			<p><em>
				Podcasting is brought to you for free by <a href="http://isitestudio.com/">TSG - iSiteStudio</a>. 
        iSiteStudio is a small web development firm specializing in Web development. 
        Visit our website to learn more, and don't hesitate to ask us to develop your 
        next Web project.
			</em></p>
