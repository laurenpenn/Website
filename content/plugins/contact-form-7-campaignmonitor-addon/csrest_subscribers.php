 ...
 *
 */
class CF7CM_CS_REST_Subscribers extends CF7CM_CS_REST_Wrapper_Base {
     ...
     * @access public
     */
    function CF7CM_CS_REST_Subscribers (
    $list_id,
    $api_key,
    $protocol = 'https',
    ...
    $transport = NULL) {
        ...
        $this->CF7CM_CS_REST_Wrapper_Base($api_key, $protocol, $debug_level, $host, $log, $serialiser, $transport);
