				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
						...
						<div class="entry-content">
							...
							<iframe width="660" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://www.29travels.com/getmap.php?j=KECNINFRRORUESMXUSAR&k=&hm=&f=&c=cc466DD7&cf=ccff0000&w=660&h=425&pd=none"></iframe>
