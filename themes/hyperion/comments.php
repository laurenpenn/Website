...
<?php if ( ! empty($comments_by_type['comment']) ) : ?>
	...
	<?php wp_list_comments('type=comment&callback=hyperion_comment'); ?>
	</ol>
	<?php endif; ?>
...
<div id="respond">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
        ...
        <label for="url"><small>Name <?php if ($req) echo "(required)"; ?></small></label></p>
        ...
        <label for="url"><small>Email (will not be published) <?php if ($req) echo "(required)"; ?></small></label></p>
        ...
        <p> <input type="checkbox" style="width: auto;" value="subscribe" id="subscribe" name="subscribe"/> <label for="subscribe">Notify me of followup comments via e-mail</label></p>
		</div>
	</form>
