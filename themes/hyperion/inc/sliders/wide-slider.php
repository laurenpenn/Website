...
<!--This is the overlay shadow for the carousel -->
...
<div id="nobar">    
    ...
    <div id="carousel-holder">
        ...
        <li>
        <img src="<?php bloginfo( 'template_directory' ); ?>/inc/timthumb.php?src=<?php echo get_post_meta( $post->ID, "feature_image", true ); ?>&amp;w=960&amp;h=317&amp;zc=1&amp;q=100" width="960" height="317" alt="<?php the_title(); ?>"/>
        
        <a class="meh" href="<?php the_permalink() ?>"></a>
        ...
        <li><img src="<?php bloginfo( 'template_directory' ); ?>/inc/timthumb.php?src=<?php echo get_option('hp_slider_image1'); ?>&amp;w=960&amp;h=317&amp;zc=1&amp;q=100" width="960" height="317" alt="<?php echo get_option('hp_slider_title1'); ?>"/>
        <a class="meh" href="<?php echo get_option('hp_slider_link1'); ?>"></a>
        ...
        <li><img src="<?php bloginfo( 'template_directory' ); ?>/inc/timthumb.php?src=<?php echo get_option('hp_slider_image2'); ?>&amp;w=960&amp;h=317&amp;zc=1&amp;q=100" width="960" height="317" alt="<?php echo get_option('hp_slider_title2'); ?>"/>
        <a class="meh" href="<?php echo get_option('hp_slider_link2'); ?>"></a>
        ...
        <li><img src="<?php bloginfo( 'template_directory' ); ?>/inc/timthumb.php?src=<?php echo get_option('hp_slider_image3'); ?>&amp;w=960&amp;h=317&amp;zc=1&amp;q=100" width="960" height="317" alt="<?php echo get_option('hp_slider_title3'); ?>"/>
        <a class="meh" href="<?php echo get_option('hp_slider_link3'); ?>"></a>
        ...
        <li><img src="<?php bloginfo( 'template_directory' ); ?>/inc/timthumb.php?src=<?php echo get_option('hp_slider_image4'); ?>&amp;w=960&amp;h=317&amp;zc=1&amp;q=100" width="960" height="317" alt="<?php echo get_option('hp_slider_title4'); ?>"/>
        <a class="meh" href="<?php echo get_option('hp_slider_link4'); ?>"></a>
        ...
        <li><img src="<?php bloginfo( 'template_directory' ); ?>/inc/timthumb.php?src=<?php echo get_option('hp_slider_image5'); ?>&amp;w=960&amp;h=317&amp;zc=1&amp;q=100" width="960" height="317" alt="<?php echo get_option('hp_slider_title5'); ?>"/>
        <a class="meh" href="<?php echo get_option('hp_slider_link5'); ?>"></a>
        ...
        <li><img src="<?php bloginfo( 'template_directory' ); ?>/inc/timthumb.php?src=<?php echo get_option('hp_slider_image6'); ?>&amp;w=960&amp;h=317&amp;zc=1&amp;q=100" width="960" height="317" alt="<?php echo get_option('hp_slider_title6'); ?>"/>
        <a class="meh" href="<?php echo get_option('hp_slider_link6'); ?>"></a>
