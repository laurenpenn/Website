...
get_header(); // Loads the header.php template. ?>
	...
	<div id="content">
		...
		<div class="row">
			...
			<div class="eight columns">
				<iframe src="http://player.vimeo.com/video/58578857?title=0&amp;byline=0&amp;portrait=0" width="800" height="449" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe> 
			</div>
			
			<div class="four columns">
				<h2>About Married Bible Fellowship</h2>
