	...
	<div id="content">
		...
		<div class="row">
			...
			<div id="social-icons" class="four columns">
				...
				<div class="three columns">		
				<a href=""><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon-vimeo.png" alt="Vimeo" /></a>
				</div>
				<div class="three columns">		
			...
			<div class="eight columns">						
				...
				<?php if ( $home_page_tabs->have_posts() ) : $i = 0; ?>
					...
					<?php while ( $home_page_tabs->have_posts() ) : $home_page_tabs->the_post(); $i++; ?>
						...
						<dd<?php if ( $i == 1 ) echo ' class="active"'; ?>>

							<a href="#simple<?php echo $i; ?>"><?php the_title_attribute(); ?></a>
