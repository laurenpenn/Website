...
if ( has_nav_menu( 'primary' ) ) : ?>
	...
	<div id="menu-primary" class="menu-container default nine columns">

		<div class="wrap">

			<?php do_atomic( 'open_menu_primary' ); // prototype_open_menu_primary ?>

			<?php wp_nav_menu( array( 'theme_location' => 'primary', 'container_class' => 'menu', 'menu_class' => 'nav-bar', 'menu_id' => 'menu-primary-items', 'fallback_cb' => '' ) ); ?>
