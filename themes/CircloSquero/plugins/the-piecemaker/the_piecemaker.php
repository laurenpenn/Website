...
EOQ;
  ...
  swfobject.embedSWF("<?php echo TP_URL . '/asset/swf/' . $swf; ?>", "the_piecemaker_slideshow", "<?php echo $width; ?>", "<?php echo $height + 150; ?>", "10", "<?php echo TP_URL; ?>/asset/js/expressInstall.swf", flashvars, attributes);
  <?php
  $script = '
