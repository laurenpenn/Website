...
<div id="slider-container"<?php if ( hybrid_get_setting( 'slider_16x9' ) == 'true' ) { echo ' class="widescreen"'; } ?>>
	...
	<div id="slider">
		...
		if ( hybrid_get_setting( 'feature_category' ) )
			$args = array( 'post_type' => 'post', 'ignore_sticky_posts' => 1, 'cat' => hybrid_get_setting( 'feature_category' ), 'posts_per_page' => hybrid_get_setting( 'feature_num_posts' ) );
		else
			$args = array( 'post__in' => get_option( 'sticky_posts' ), 'posts_per_page' => hybrid_get_setting( 'feature_num_posts' ) );
		?>
