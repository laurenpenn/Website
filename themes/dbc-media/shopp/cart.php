...
<p class="cart-nav">
	...
	<a href="<?php shopp('checkout','url'); ?>" class="floatright proceed-to-checkout">Checkout</a>
	<?php endif; ?>
</p>
...
<table class="cart">
	...
	<tr class="totals">
		<td colspan="2" rowspan="5">
			...
			<p style="margin: 0;"><strong>Please enter your zip code:</strong></p>
			<div id="shipping-options"><?php shopp('cart','shipping-estimates'); ?> <?php shopp('cart','update-button'); ?></div>
			<?php endif; ?>
			<div id="promo-code"><?php shopp('cart','promo-code'); ?></div>
		</td>
