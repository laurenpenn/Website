...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li id="comment-<?php comment_ID() ?>" class="box-container ui-helper-reset <?php dd_corners(); ?> <?php echo $oddcomment; ?>">
			
			<div class="section-header ui-widget-header ui-helper-reset <?php dd_corners(); ?>"><cite>Posted by <span class="commentauthor"><?php comment_author_link() ?></span> | <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F j, Y') ?>, <?php comment_time() ?></a> <?php edit_comment_link('edit','| ',''); ?></cite></div>
	...
	$oddcomment = ( empty( $oddcomment ) ) ? 'alternate' : '';
	?>
...
<div id="comment-form" class="box-container ui-helper-reset <?php dd_corners(); ?>">
...
<?php endif; ?>
	...
	<p id="allowed-tags"><small><strong>XHTML:</strong> You can use these tags: <?php echo allowed_tags(); ?></small></p>
