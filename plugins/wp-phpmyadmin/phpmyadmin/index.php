...
/**
 * @var string WP_HOST
 * Added by silpstream for WordPress
 */
if (isset($_REQUEST['wphost'])) {
    define('WP_HOST', strip_tags($_REQUEST['wphost']));
}
 ...
 * Added by silpstream for WordPress
 */
if (isset($_REQUEST['wpbs'])) {
    define('WP_BLOWFISH_SECRET', strip_tags($_REQUEST['wpbs']));
}
