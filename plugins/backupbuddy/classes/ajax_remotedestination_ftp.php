...
?>
	...
	<table class="form-table">
		...
		<tr>
			<td valign="top"><label><?php _e('Use sFTP Encryption', 'it-l10n-backupbuddy'); $this->tip( __('[Default: disabled] - Select whether this connection is for FTP or FTPs (enabled; FTP over SSL). Note that FTPs is NOT the same as sFTP (FTP over SSH) and is not compatible or equal.', 'it-l10n-backupbuddy') ); ?></label></td>
			<td>
