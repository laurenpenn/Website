							...
							<table class="form-table">
								...
								<tr>
									...
									<td>
										...
										<input type="checkbox" name="#backup_reminders" id="backup_reminders" value="1" <?php if ( $this->_options['backup_reminders'] == '1' ) { echo 'checked'; } ?> /> <label for="high_security"><?php _e('Enable backup reminders', 'it-l10n-backupbuddy');?></label>
									</td>
								</tr>
								<tr>
						...
						<div class="inside">
							<table class="form-table">
								<tr>
									...
									<td>
										<?php
											echo __('Excluded directories (path relative to root)' , 'it-l10n-backupbuddy');
