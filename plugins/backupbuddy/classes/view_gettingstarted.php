		...
		<div class="postbox-container" style="width:70%;">
			...
			<p>
				...
				<ol>
					...
					<li type="disc"><i><?php _e('Local backup storage directory', 'it-l10n-backupbuddy');?>: <input size="70" type="text" value="<?php echo str_replace( '\\', '/', $this->_options['backup_directory'] ); ?>"><?php $this->tip(' ' . __('This is the local directory that backups are stored in. Backup files include random characters in their name for increased security. BackupBuddy must be able to create this directory & write to it.', 'it-l10n-backupbuddy') ); ?></i></li>
				</ol>
